...
def ventanaAgregar():
    def enviar(anio, mes, dia, mensaje, id_):
        mensaje = mensaje.get()
        anio = anio.get()
        mes = mes.get()
        dia = dia.get()   
    ...
    def agregando(celular, id_):
        ...
        #enviar datos
        ventana_agregar.boton_enviar = v.tk.Button(ventana_agregar, text="Subir datos", command=lambda : enviar(anio, mes, dia, mensaje, id_), font = fuente_personalizada, width=20, height=5, bg = "#0a8012")
